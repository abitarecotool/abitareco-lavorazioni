(() => {
  ...
  function bindUI(){
    ...
    document.addEventListener('click', e => {
      if(!e.target.closest('#CollabPicker')) $('#CollabPanel')?.classList.add('hidden');
      if(!e.target.closest('.admin-collab-dropdown')) $$('.admin-collab-menu').forEach(m => m.classList.add('hidden'));
    });
  }
